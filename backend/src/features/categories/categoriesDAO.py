    ...
    def update_category(category_id: str, categoryupdt: Category):
        ...
        for category in cdb:
            if category["id"] == category_id:
                ...
                category["keywords"] = categoryupdt.keywords 
                category["description"] = categoryupdt.description
                category["image"] = categoryupdt.image
        
                write_categories_db(cdb)
                return category
        # segue nessa mesma logica para os outrosx campos
